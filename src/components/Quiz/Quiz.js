        ...
        {this.state.showScore ? (<div className="score-section">You scored {this.state.score}out of {this.state.questions.length} </div>) : (
          <>
            ...
            <div className="answer-section">
              {this.state.questions[this.state.currentQuestion].answerOptions.map((answerItem, index) => (
                <div key={index}>
                    <button
                        onClick={() => {this.answerisCorrect(answerItem.isCorrect);}}>{answerItem.answerText}
                    </button>
                </div>
              ))}
            </div>
